 ...
 *
 * generated by
 *     /usr/bin/perl /home/osnapdev/322/postgres/src/bin/psql/create_help.pl /home/osnapdev/322/postgres/doc/src/sgml/ref sql_help
 *
 */
...
sql_help_ALTER_SUBSCRIPTION(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  ...
					  "ALTER SUBSCRIPTION %s CONNECTION 'conninfo'\n"
					  "ALTER SUBSCRIPTION %s SET PUBLICATION publication_name [, ...]\n"
...
{
	appendPQExpBuffer(buf,
					  "CREATE SUBSCRIPTION %s CONNECTION 'conninfo' PUBLICATION { publication_name [, ...] } [ WITH ( %s [, ... ] ) ]\n"
					  "\n"
					  "%s\n"
					  "\n"
					  "    | ENABLED | DISABLED\n"
...
sql_help_CREATE_TABLE(PQExpBuffer buf)
{
	appendPQExpBuffer(buf,
					  ...
					  "\n"
					  "{ IN ( %s [, ...] ) |\n"
					  "  FROM ( { %s | UNBOUNDED } [, ...] ) TO ( { %s | UNBOUNDED } [, ...] ) }\n"
					  "\n"
					  "%s\n"
					  "\n"
					  "[ WITH ( %s [= %s] [, ... ] ) ]\n"
...
{
	appendPQExpBuffer(buf,
					  "DROP SUBSCRIPTION [ IF EXISTS ] %s [ %s | %s ]",
					  _("name"),
					  _("DROP SLOT"),
					  _("NODROP SLOT"));
}
